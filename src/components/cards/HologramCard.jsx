...
export default function HologramCard({
    ...
    return (
        ...
        >
            <Link href={`/tours?destination=${region}`}>
                <motion.div
                ...
                >
                    ...
                    <div className="relative h-32 xs:h-36 sm:h-40 md:h-48 overflow-hidden">
                        ...
                        <div className="absolute top-4 left-4 z-10">
                            <span className="glass-badge px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-gold-400 text-[10px] sm:text-xs uppercase tracking-wider font-semibold">
                                {era}
                            </span>
                        </div>
